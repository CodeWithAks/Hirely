  ...
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100  '>
      ...
      <div>
        ...
        <p className='text-sm text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi at ut culpa, aspernatur molestias nisi voluptatum nulla deleniti sed maiores!</p>
      </div>
